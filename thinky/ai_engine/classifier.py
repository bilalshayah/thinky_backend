...
# 🧠 التوجيهات النفسية والتربوية بالعامية السورية المخصصة لكل نمط (عمر 10 سنوات)
        strategies = {
           ...
           "MASTER": (
        "الولد عبقري وما شاء الله عليه حافط القواعد وممتاز!؛ "
        "أعطيه لغز أو تحدي رياضيات قوي وسريع بأسلوب حماسي وقلو: 'يا بطل، أنت ملك الرياضيات وهاد التحدي خصيصاً للعباقرة مثلك، أثبتلي إنك بتئدر تحلو!'"
    )
        }
...
2. أظهر تفاجئك الدرامي أو شكك اللطيف بذكائه (مثلاً: "مستحيل! كيف حليت كل شي صح؟ اكيد صدفة !").
